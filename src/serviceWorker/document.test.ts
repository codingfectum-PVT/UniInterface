...
describe('document', () => {
  describe('matchDocument', () => {
    const TEST_DOCUMENTS = [
      ...
      [{ request: {}, url: { hostname: 'testnet.spillways.finance', pathname: '' } }, false],
      [{ request: { mode: 'navigate' }, url: { hostname: 'testnet.spillways.finance', pathname: '' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'testnet.spillways.finance', pathname: '/#/swap' } }, true],
      [{ request: { mode: 'navigate' }, url: { hostname: 'testnet.spillways.finance', pathname: '/asset.gif' } }, false],
